 ...
 *
 * @FieldType(
 *   id = "geojsonfile_field_test",
 *   label = @Translation("Geojson File Test"),
 *   description = @Translation("This field stores Geojson file and style Test."),
 *   category = @Translation("Custom"),
 *   default_widget = "geojsonfile_widget_test",
 *   default_formatter = "geojsonfile_formatter_test",
 *   cardinality = -1,
 * )
 */
//default_formatter = "leaflet_edit_formatter",
class GeoJsonFileTest extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['track']['max_filesize'] = [
      ...
      '#description' => $this->t('Enter a value like "512" (bytes), "80 KB" (kilobytes) or "50 MB" (megabytes) in order to restrict the allowed file size. If left empty the file sizes could be limited only by PHP\'s maximum post and file upload sizes .'),
      '#size' => 10,
